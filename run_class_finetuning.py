...
def get_dataset(args):
    if args.dataset == 'TUAB':
        train_dataset, test_dataset, val_dataset = utils.prepare_TUAB_dataset("/share/TUAB/processed")
        ch_names = ['EEG FP1', 'EEG FP2-REF', 'EEG F3-REF', 'EEG F4-REF', 'EEG C3-REF', 'EEG C4-REF', 'EEG P3-REF', 'EEG P4-REF', 'EEG O1-REF', 'EEG O2-REF', 'EEG F7-REF', \
                    'EEG F8-REF', 'EEG T3-REF', 'EEG T4-REF', 'EEG T5-REF', 'EEG T6-REF', 'EEG A1-REF', 'EEG A2-REF', 'EEG FZ-REF', 'EEG CZ-REF', 'EEG PZ-REF', 'EEG T1-REF', 'EEG T2-REF']
        ch_names = [name.split(' ')[-1].split('-')[0] for name in ch_names]
        args.nb_classes = 1
        metrics = ["pr_auc", "roc_auc", "accuracy", "balanced_accuracy"]
    elif args.dataset == 'Workload':
        train_dataset, test_dataset, val_dataset = utils.prepare_Workload_dataset("/userhome1/zhangjianming/lin/ML/EEGWorkload")
        ch_names = ['FP1', 'FP2', 'F3', 'F4', 'F7', 'F8', 'T3', 'T4', 'C3', 'C4', 'T5', 'T6', 'P3', 'P4', 'O1', 'O2', 'FZ', 'CZ', 'PZ']
        ch_names = [name.split(' ')[0].split('-')[0] for name in ch_names]
        args.nb_classes = 1
        metrics = ["pr_auc", "roc_auc", "accuracy", "balanced_accuracy"]
    elif args.dataset == 'TUEV':
        train_dataset, test_dataset, val_dataset = utils.prepare_TUEV_dataset("/share/TUEV")
        ...
        eeg_max_len, text_max_len = 276, 80
        train_dataset = utils.SEEDDataset(Path('/share/h5Data/seed-3.hdf5'), window_size=800, stride_size=800, trial_start_percentage=0, 
                                        trial_end_percentage=0.6, is_instruct=False, eeg_max_len=eeg_max_len, text_max_len=text_max_len)
        val_dataset = utils.SEEDDataset(Path('/share/h5Data/seed-3.hdf5'), window_size=800, stride_size=800, trial_start_percentage=0.6, 
                                    trial_end_percentage=0.8, is_instruct=False, is_val=True, eeg_max_len=eeg_max_len, text_max_len=text_max_len)
        test_dataset = utils.SEEDDataset(Path('/share/h5Data/seed-3.hdf5'), window_size=800, stride_size=800, trial_start_percentage=0.8, 
                                    trial_end_percentage=1, is_instruct=False, is_val=True, eeg_max_len=eeg_max_len, text_max_len=text_max_len)
        ch_names = ['FP1', 'FPZ', 'FP2', 'AF3', 'AF4', 'F7', 'F5', 'F3', 'F1', 'FZ', 'F2', 'F4', 'F6','F8', 'FT7', 'FC5', 'FC3', 'FC1', 'FCZ', 'FC2', 'FC4', 'FC6', 'FT8', 'T7', 'C5', 'C3', \
                    'C1', 'CZ', 'C2', 'C4', 'C6', 'T8', 'TP7', 'CP5', 'CP3', 'CP1', 'CPZ', 'CP2', 'CP4', 'CP6', 'TP8', 'P7', 'P5', 'P3', 'P1', 'PZ', 'P2', 'P4', 'P6', 'P8', 'PO7', 'PO5', \
...
def main(args, ds_init):
    ...
    print("Number of training examples = %d" % len(dataset_train))
    print("Number of val examples = %d" % len(dataset_val))
